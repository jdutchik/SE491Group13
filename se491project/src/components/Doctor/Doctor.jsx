...
const Doctor = () => {
    ...
    const getDoctorInfo = async () => {
        try {
            const response = await fetch(`http://ec2-54-174-30-87.compute-1.amazonaws.com:3001/doctor/${username}`, {
                method: 'GET'
            });
    ...
    const getAllergenResults = async () => {
        try {
            const response = await fetch(`http://ec2-54-174-30-87.compute-1.amazonaws.com:3001/products/${patientInfo.username}`, {
                method: 'GET'
            });
